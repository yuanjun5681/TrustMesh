...
const eventConfig: Record<EventType, { icon: typeof Circle; color: string; label: string }> = {
  ...
  todo_interrupted: { icon: AlertTriangle, color: 'text-warning', label: 'Todo 中断' },
  task_interrupted: { icon: AlertTriangle, color: 'text-warning', label: '任务中断' },
  task_resumed: { icon: RotateCcw, color: 'text-info', label: '任务恢复' },
